...
- 完成时间：
- Task ID：cgt-20260901194749-s2qt9

## 输入文件

- Prompt：/Users/kaiyi.wang/IdeaProjects/ktoking/aigc-agent/stories/forest-villa-apocalypse/episodes/EP034_frost-siege/segment_03_30-45s/director-promt.txt
- 本地参考图：
- /Users/kaiyi.wang/IdeaProjects/ktoking/aigc-agent/stories/forest-villa-apocalypse/assets/zombies/references/chained-thick-skin-brute-canonical-16x9.png
...
- API图片5：local_image / FVA_CHAINED_BRUTE_MUTANT_001

兼容旧剧集：数字人资产位于顶部身份锁，提示词 `参考图` 仅编号非人物素材。

## 提示词参考图顺序

- 参考图1：FVA_CHAINED_BRUTE_MUTANT_001
