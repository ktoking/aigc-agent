# Segment 06 API 请求（150-180s，30s）
...
5. `frames/ref-original-canyon-bridge.png` — 用户提供的原始关键帧，仅按README指定职责使用
6. `frames/ref-original-giant-brute.png` — 用户提供的原始关键帧，仅按README指定职责使用
7. `frames/ref-original-lead-sniper.png` — 用户提供的原始关键帧，仅按README指定职责使用
8. `frames/ref-original-purification-chamber.png` — 用户提供的原始关键帧，仅按README指定职责使用
9. `frames/ref-station-direction.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
10. `frames/ref-station-tracks.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
11. `frames/ref-train-coupler.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
12. `frames/ref-train-shape.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
