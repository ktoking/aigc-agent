# Segment 08 API 请求（210-240s，30s）
...
10. `frames/ref-original-water-station-active.png` — 用户提供的原始关键帧，仅按README指定职责使用
11. `frames/ref-station-tracks.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
12. `frames/ref-train-coupler.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
