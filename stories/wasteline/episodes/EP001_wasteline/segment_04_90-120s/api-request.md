...
3. `frames/ref-brute-foreshadow.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
4. `frames/ref-canyon-direction.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
5. `frames/ref-drone-front.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
