...
3. `frames/ref-canyon-direction.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
4. `frames/ref-drone-front.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
5. `frames/ref-dry-wasteland.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
6. `frames/ref-lead-lock.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
