# Segment 05 API 请求（120-150s，30s）
...
5. `frames/ref-drone-damage-context.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
6. `frames/ref-original-armored-train.png` — 用户提供的原始关键帧，仅按README指定职责使用
7. `frames/ref-original-canyon-bridge.png` — 用户提供的原始关键帧，仅按README指定职责使用
8. `frames/ref-original-giant-brute.png` — 用户提供的原始关键帧，仅按README指定职责使用
9. `frames/ref-original-lead-sniper.png` — 用户提供的原始关键帧，仅按README指定职责使用
10. `frames/ref-station-direction.png` — 剧情补充参考资产；用途由文件名及本段prompt.md确定
